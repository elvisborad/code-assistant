...
def get_client():
    ...
    api_key = os.environ.get("GEMINI_API_KEY", "AIzaSyAK1B_wjrv6ADYFg4GkCFWmI3QNhGaDvoo")
    if not api_key:
...
def debug():
    ...
    key = os.environ.get("GEMINI_API_KEY", "AIzaSyAK1B_wjrv6ADYFg4GkCFWmI3QNhGaDvoo")
